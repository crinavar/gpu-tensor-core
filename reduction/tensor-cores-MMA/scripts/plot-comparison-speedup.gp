...
out = '../plots/plot_cub_speedup_Titan'.gpu.'_'.dist.'.eps'
...
set key Right bot right reverse samplen 3.0 font "Courier,18" spacing 1 
...
set key Right bot right title 'Methods:' font "Courier,18"
#set log y

plot    '../data/cub_titan'.gpu.'_'.dist.'.dat' using 1:($26/($2)) title "TC-CHAIN-R4" with lp ls 3,\
        '../data/cub_titan'.gpu.'_'.dist.'.dat' using 1:($26/($10)) title "CUB16" with lp ls 6,\
        '../data/cub_titan'.gpu.'_'.dist.'.dat' using 1:($26/($18)) title "CUB32" with lp ls 7
