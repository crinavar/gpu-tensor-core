...
plot    singlepass  using 1:($4/$15) title "single-pass" with lp ls 1,\
        cub16       using 1:($4/$13) title "CUB (half)"  with lp ls 3,\
        cub32       using 1:($4/$13) title "CUB (float)" with lp ls 2
