...
out     = 'plots/plot-comparison-speedup-'.gpu.'_'.dist.'.eps'
...
# variables
singlepass  = '< paste data/alg-warpshuffle-'.gpu.'-'.dist.'-B1024.dat data/alg-singlepass-R4-'.gpu.'-'.dist.'-B32.dat'
...
plot    singlepass  using 1:($4/$13) title "single-pass" with lp ls 1,\
        cub16       using 1:($4/$13) title "CUB (half)"  with lp ls 2,\
        cub32       using 1:($4/$13) title "CUB (float)" with lp ls 3
