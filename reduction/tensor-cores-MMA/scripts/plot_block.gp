...
out = '../plots/plot_block_Titan'.gpu.'_'.dist.'.eps'
title = "Runtime Tensor-Shuffle Reduction\n".dist." Distribution\nTitan ".gpu 
...
plot    '../data/block_titan'.gpu.'_'.dist.'.dat' using 1:2 title "B32" with line ls 1,\
        '../data/block_titan'.gpu.'_'.dist.'.dat' using 1:10 title "B128" with line ls 2,\
        '../data/block_titan'.gpu.'_'.dist.'.dat' using 1:18 title "B256" with line ls 3,\
        '../data/block_titan'.gpu.'_'.dist.'.dat' using 1:26 title "B512" with line ls 4,\
        '../data/block_titan'.gpu.'_'.dist.'.dat' using 1:34 title "B1024" with line ls 6
