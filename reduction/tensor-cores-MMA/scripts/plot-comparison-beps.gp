...
out     = 'plots/plot-comparison-BEPS-'.gpu.'_'.dist.'.eps'
mytitle = "BEPS vs CUB Library (".gpu.")\n".dist." Distribution\n ".gpu
...
plot    singlepass  using 1:($1/$4) title "single-pass"     with lp ls 1,\
        cub16       using 1:($1/$2) title "CUB (half)"      with lp ls 2,\
        cub32       using 1:($1/$2) title "CUB (float)"     with lp ls 3
