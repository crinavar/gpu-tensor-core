...
BINARY=${9}
OUTFILE=${10}
METHODS=("shuffle" "tc_theory" "tc_blockshuffle" "tc_mixed" "tc_chain_2" "tc_chain_4" "tc_chain_8")
NM=$((${#METHODS[@]}-1))
met=("0" "1" "2" "3" "2" "2" "2")
chain=("1" "1" "1" "1" "2" "4" "8")
ns=("0" "0" "0" "0.5" "0" "0" "0")
BSIZE=("1024" "1024" "256" "256" "32" "32" "32")
TMEAN[0]=0
TVAR[0]=0
TSTDEV[0]=0
TSTERR[0]=0
...
do
    ...
    echo -n "${N}       " >> ../data/${OUTFILE}_${DISTRIBUTION[$DIST]}.dat
    for B in 32 128 256 512 1024;
    do
        #echo $N
        M=0
        S=0
        ...
        v2=0
            ...
            echo " "
            echo "${METHODS[$q]}     -->     R=$R and  BSIZE=$B"
