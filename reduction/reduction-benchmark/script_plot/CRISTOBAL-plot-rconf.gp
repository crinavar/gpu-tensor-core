...
out = '../plots/JOURNAL-rconf-chained'.gpu.'_'.dist.'.eps'
title = "Running time (".gpu.")\nChained MMAs, N {/Symbol \273} 1.4Bi" 
...
plot '../data/CRISTOBAL-rconf-'.gpu.'_'.dist.'_B128.dat' using 3:4 title "B128" with lines ls 4,\
     '../data/CRISTOBAL-rconf-'.gpu.'_'.dist.'_B512.dat' using 3:4 title "B512" with lines ls 3,\
     '../data/CRISTOBAL-rconf-'.gpu.'_'.dist.'_B1024.dat' using 3:4 title "B1024" with lines ls 2,\
     '../data/CRISTOBAL-rconf-'.gpu.'_'.dist.'_B32.dat' using 3:4 title "B32" with lines ls 1,\
