...
title = "Runtime Chained Reduction\n".dist." Distribution\nTitan ".gpu 
...
plot    '../data/rconf_titan'.gpu.'_'.dist.'.dat' using 2:10 title "B32" with line ls 1,\
        '../data/rconf_titan'.gpu.'_'.dist.'.dat' using 2:18 title "B128" with line ls 2,\
        '../data/rconf_titan'.gpu.'_'.dist.'.dat' using 2:26 title "B512" with line ls 3,\
        '../data/rconf_titan'.gpu.'_'.dist.'.dat' using 2:34 title "B1024" with line ls 4
